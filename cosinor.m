...
% Substituition
x = cos(w.*t); %w is the cycle length (e.g. 2*pi/tau)
z = sin(w.*t);
...
%% II. Confidence Limits for Single Cosinor
...
%% III Create a return structure
cosinorStruct.Mesor      = M;
cosinorStruct.Amp        = Amp;
cosinorStruct.Phi        = phi;
cosinorStruct.f          = f;
cosinorStruct.CI_Amp_min = CI_Amp_min;
cosinorStruct.CI_Amp_max = CI_Amp_max;
cosinorStruct.CI_phi_min = CI_phi_min;
cosinorStruct.CI_phi_max = CI_phi_max;
cosinorStruct.p = p_3a;